 ...
 * - plays MP3 and M4A from SD card with the awesome lib by Frank Bösing
 *  
 * TODO:
...
#define MENU_PLAYER                       2
#define MENU_CALIBRATION_FACTOR           3
#define MENU_CALIBRATION_CONSTANT         4
#define MENU_IQ_AMPLITUDE                 5
#define MENU_IQ_PHASE                     6  
#define MENU_LPF_SPECTRUM                 7
#define MENU_SAVE_EEPROM                  8
#define MENU_LOAD_EEPROM                  9
...
#define MENU_RF_GAIN                      0
#define MENU_VOLUME                       1
#define MENU_SAM_TAU                      2
#define MENU_SAM_BW                       3
#define MENU_SAM_CATCH_BW                 4
#define first_menu2                       0
#define last_menu2                        4  
uint8_t Menu2 =                           MENU_RF_GAIN;
 ...
 **********************************************************************************/
    ...
    if (Q_in_L.available() > N_BLOCKS && Q_in_R.available() > N_BLOCKS && Menu != MENU_PLAYER)
    {   
...
//                  audio_flag = 0;
               ...
               if(Menu == (MENU_PLAYER + 1) || (Menu == 0 && MENU_PLAYER == last_menu))
               {
                  // stop all playing
                  playMp3.stop();
                  playAac.stop();
...
//         show_band(bands[band].name); // show new band
         ...
         sgtl5000_1.lineInLevel(bands[band].RFgain, (float) bands[band].RFgain);
