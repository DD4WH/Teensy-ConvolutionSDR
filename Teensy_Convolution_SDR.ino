 ...
 * - manual notch filter implemented [in the frequency domain: simply delete bins before the iFFT] 
 * - bandwidth adjustment of manual notch filter implemented
 * - graphical display of manual notch filters in the frequency domain
 *  
 * TODO:
 * - improve ringing of the brickwall filter (other window algorithm ? Postfilter = IIR notch filter at the stop frequency ?)
...
#define MENU_STEREO_FACTOR                35
#define MENU_AGC_HANG_ENABLE              36
#define MENU_AGC_HANG_TIME                37
#define MENU_AGC_HANG_THRESH              38
#define first_menu2                       17
#define last_menu2                        35  
