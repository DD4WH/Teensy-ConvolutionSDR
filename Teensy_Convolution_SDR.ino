...
#define MENU_CALIBRATION_FACTOR           5
#define MENU_CALIBRATION_CONSTANT         6
#define MENU_LPF_SPECTRUM                 9
#define MENU_SAVE_EEPROM                  10
#define MENU_LOAD_EEPROM                  11
...
//        for (int idx = -3; idx < 4; idx++)
        {
            ...
            if(spectrum_zoom > 2 || freq_calc > 10000)
            {
                idx++;
            }
        }
...
//**************************************************************************
    ...
    if(spectrum_zoom < 3 && freq_calc <= 10000)
    {
