...
void calc_spectrum_mags(uint32_t zoom, float32_t LPFcoeff) {
      ...
      LPFcoeff = LPFcoeff * (AUDIO_SAMPLE_RATE_EXACT / SR[SAMPLE_RATE].rate) * (AUDIO_SAMPLE_RATE_EXACT / SR[SAMPLE_RATE].rate);
...
void buttons() {
      ...
      button5.update();
            ...
            if ( button5.fallingEdge()) { // cycle thru tune steps
                ...
                else if (tune_stepper == 2) tunestep = 1000 / 4;
                else if (tune_stepper == 3) tunestep = 100 / 4;
                show_tunestep(); 
            }
}
