 ...
 *   and disabled spectrum display in WFM STEREO mode, because the digital noise of the refresh of the spectrum display did seriously distort audio
 *  
 * TODO:
...
*/
            ...
            if ( button3.fallingEdge()) {  // cycle through DEMOD modes
              ...
              else
              {
                ...
                show_analog_gain(); 
                if(band[bands].mode == DEMOD_WFM) show_spectrum_flag = 0;
                if(band[bands].mode == DEMOD_WFM + 1) show_spectrum_flag = 1;
                delay(10);
                AudioInterrupts();
                sgtl5000_1.dacVolume(1.0);
             }
