...
#define       DEMOD_STEREO_LSB   11 // LSB, with pseude-stereo effect
#define       DEMOD_STEREO_USB   12 // USB, with pseude-stereo effect
#define       DEMOD_DCF77        13 // set the clock with the time signal station DCF77
#define       DEMOD_AUTOTUNE     14 // AM demodulation with autotune function
#define       DEMOD_STEREO_DSB   15 // double sideband: SSB without eliminating the opposite sideband
#define       DEMOD_DSB          16 // double sideband: SSB without eliminating the opposite sideband
#define       DEMOD_SAM          17 // synchronous AM demodulation
#define       DEMOD_AM_USB       18 // AM demodulation with lower sideband suppressed
#define       DEMOD_AM_LSB       19 // AM demodulation with upper sideband suppressed
#define       DEMOD_AM_LYONS     20 // AM demodulation with simplified demodulator
#define       DEMOD_AM_LIBCSDR   21 // AM demodulation with |I| + |Q|
#define       DEMOD_MAX          10
#define BAND_LW     0   
#define BAND_MW     1
#define BAND_120M   2
...
//  7750000 ,"VLF", DEMOD_AM, 3600,3600,0,  
  ...
  53100000,"MW",  DEMOD_AM1, 3600,3600,0,
...
const DEMOD_Descriptor DEMOD [18] =
{
    //   DEMOD_n, name
    {  DEMOD_USB, " USB  "}, 
    {  DEMOD_LSB, " LSB  "}, 
 ...
 **********************************************************************************/
      // this is for +Fs/4 [moves receive frequency to the left in the spectrumdisplay]
